...
var modals = function modals() {
  ...
  var btnPressed; // Определение ширины полосы прокрутки
  ...
  } // открывает модальное окно при долистывании до конца экрана (только в том случае, если до этого ни одна кнопка не была нажата). После этого Подарок скрывается


  function scrollBottomOpen(modalSelector, triggerSelector) {
    window.addEventListener('scroll', function () {
      if (!btnPressed && document.documentElement.scrollHeight <= document.documentElement.clientHeight + document.documentElement.scrollTop) {
